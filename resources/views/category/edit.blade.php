        ...
        <form role="form" action="{{url("admin/update-category/{$category->__get("id")}")}}" method="post">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input class="form-control value={{$category->__get("category_name")}} @error("category_name") is-invalid @enderror" type="text" name="category_name" placeholder="Enter Name"/>
                    @error("category_name")
